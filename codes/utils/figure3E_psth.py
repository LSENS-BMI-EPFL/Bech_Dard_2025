...
def figure3e_psth(table, saving_path, name, formats=['png']):
    ...
    data_to_plot = coord_mouse_df.loc[coord_mouse_df.trial_type == 'auditory_hit_trial']

    # Select grid points
    selected_spots = ['(-2.5, 5.5)', '(-1.5, 3.5)', '(1.5, 1.5)', '(-1.5, 0.5)', '(2.5, 2.5)', '(0.5, 4.5)']
